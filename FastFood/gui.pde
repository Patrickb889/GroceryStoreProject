...
public void createGUI(){
  ...
  saveStoreButton = new GButton(Window, 24, 127, 100, 40);
  ...
  animationCheckbox = new GCheckbox(Window, 174, 153, 120, 18);
  ...
  supplyCheckbox = new GCheckbox(Window, 174, 117, 120, 33);
  ...
  label1 = new GLabel(Window, 69, 180, 161, 20);
  label1.setTextAlign(GAlign.CENTER, GAlign.MIDDLE);
  label1.setText("Busyness of Store");
  label1.setOpaque(false);
  busynessSlider = new GSlider(Window, 49, 200, 200, 53, 10.0);
